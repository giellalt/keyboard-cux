# Keyboards for Tepeuxila Cuicatec
...
keyboards for the Tepeuxila Cuicatec language. The code
...
The Tepeuxila Cuicatec keyboard sources can be acquired using the Fork or Code
